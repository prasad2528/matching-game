        ...
        <div className="bg-container">
            ...
            <div className="main-div">
                ...
                {tabsList.map(eachValue => (
                  <li key={eachValue.tabId}>
                    <button
                      type="button"
                      className={`tab-item ${
                        category === eachValue.tabId ? 'highlight' : ''
                      }`}
              ...
              <ul className="thumbnail-list">
                {thumbnailList.map(eachValue => (
                  <li key={eachValue.id} className="img">
                    <button
                      className="img-button"
                      type="button"
                      onClick={() =>
                        this.onClickImageUrl(eachValue.thumbnailUrl)
                      }
                    >
                      <img
          ...
          {isTrue && (
            <div className="player-card">
              ...
              <p className="last-score">{score}</p>
              <button
                type="button"
                className="reset-btn"
